...
public class LongestStreakProcessorTests {

    public static class LongestStreakProcessorTestClass extends KeyedProcessOperator<String, AQIValue24h, Streak> {

        public LongestStreakProcessorTestClass() {
            super(new LongestStreakProcessor());
        }
    }
...
/*
    ...
    public void initialManyBatchesInFirst5MinutesTest() throws Exception {
        ...
        KeyedOneInputStreamOperatorTestHarness<String, AQIValue24h, Streak> testHarness =
